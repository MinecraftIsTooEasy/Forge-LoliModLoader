...
public class NetClientHandlerMixin {
    ...
    @ModifyConstant(method = "handleBlockFX", constant = @Constant(intValue = 8), slice = @Slice(from = @At(value = "FIELD",
            target = "Lnet/minecraft/util/EnumBlockFX;destroy:Lnet/minecraft/util/EnumBlockFX;")))
    private int moveBlockFXOriginalBlockReadPtr(int original){
        return 12;
    }

    @ModifyConstant(method = "handleBlockFX", constant = @Constant(intValue = 12), slice = @Slice(from = @At(value = "FIELD",
            target = "Lnet/minecraft/util/EnumBlockFX;destroy:Lnet/minecraft/util/EnumBlockFX;")))
    private int moveBlockFXSuccessorBlockReadPtr(int original){
        return 16;
    }

    @ModifyConstant(method = "handleBlockFX", constant = @Constant(intValue = 20), slice = @Slice(from = @At(value = "FIELD",
            target = "Lnet/minecraft/util/EnumBlockFX;destroy:Lnet/minecraft/util/EnumBlockFX;")))
